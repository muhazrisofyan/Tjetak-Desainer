...
<div class="" style="margin-top:60px">
  ...
  <div class="w3-center w3-padding-24 w3-content">
    <h1>Job Saya</h1>
    <p>Anda memiliki 2 Job Desain</p>
    <div class="w3-row">
      <div class="w3-threequarter">
        <div class="w3-padding-8 box w3-round w3-padding" style="margin-top:5px">
      ...
      <div class="w3-quarter w3-container">
        <table class="width-100">
          <tr>
            <td style="text-align:left;width:60px"><p>Status : </p></td>
            <td>
              <select class=" w3-select w3-border w3-white w3-padding"
               id="sel_id" name="sel_name"  onchange="this.form.submit();" style="height:33px">
                <option value="-1">Semua</option>
                <option value="6">compfest ada </option>
      ...
      <div class="w3-card-4 w3-dark-grey">
        <div class=" w3-center" style="line-height: 50%">
          ...
          <div class="text-left w3-container">
            <h5><a href="/myjobdetail">Desain Poster</a>...</h5>
            <p>Rp. 1.250.000,00</p>
